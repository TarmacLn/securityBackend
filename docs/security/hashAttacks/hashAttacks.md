...
| Εργαλείο | Χρήση | Λόγος Επιλογής |
|----------|-------|----------------|
| **Hashcat** | Brute-force attacks | Υποστήριξη GPU για ταχύτερες επιθέσεις |
...
Φτιάχνουμε κανόνες όπου θα μετατρέπει όλες τις λέξεις σε λέξεις με εναλλαγές πεζώμ-κεφαλαίων (περιορισμός του rule 10 σύμβολα)
...
- **Παρατήρηση:** Η επίθεση ήταν πολύ γρήγορη (<1s) λόγω:
    1. Απλό συνθηματικό
    2. Η γνώση του μοτίβου μετέτρεψε μια δύσκολη επίθεση σε τετριμμένη
