...
* Λειτουργικό Σύστημα: Debian 12 (Docker)
* Εξυπηρετητής Ιστού: NGINX v1.29.3
* Εξυπηρετητής εφαρμογής: Jetty v11.0.25 (embedded via Javalin)
* Εξυπηρετητής βάσης δεδομένων: SQLite 3.49.1.0
* Πρωτόκολλο ασφάλειας SSL/TLS: το SSL/TLS χειρίζεται το NGINX (reverse proxy)
...
| --- | --- | --- |
| **HW** | **Server** (μοντέλο, χαρακτηριστικά) <br> **Τοποθεσία** (κτήριο, δωμάτιο) | Docker <br> Greece |
| **SW** | **Λειτουργικό Σύστημα** (πυρήνας, έκδοση) <br> **Λογισμικό Εφαρμογών** <br> **Άλλο Λογισμικό** | Debian 12 x86-64 <br> Docker Container 28.5.1 <br> Eclipse Temurin 21 JRE with (compiles to Java 8 bytecode), Javalin 6.6.0 (web framework), ActiveJDBC 3.5-j11 (ORM) |
